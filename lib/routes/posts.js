...
module.exports = function (hexo) {
    ...
    router.get('/:type(post|draft)/:slug', function (req, res) {
        const query = {
            slug: req.params.slug,
            published: req.params.type === 'post'
        }
    ...
    router.patch('/:type(post|draft)/:slug', function (req, res) {
        const query = {
            slug: req.params.slug,
            published: req.params.type === 'post'
        }
    ...
    //delete post
    router.delete('/:type(post|draft)/:slug', function (req, res) {
        const query = {
            slug: req.params.slug,
            published: req.params.type === 'post'
        }
